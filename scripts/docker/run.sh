...
[ "$architecture" == "amd64" ] && image=portainer/portainer:1.16.4
[ "$architecture" == "i386" ]  && image=portainer/portainer:linux-386-1.16.4
[ "$architecture" == "armhf" ] && image=portainer/portainer:linux-arm-1.16.4
